...
public class ExportExcel2007 {
     ...
     * @param objects   数据信息
     */
    public void writeExcelData(String directory, String fileName, String sheetName, List<List> objects)
            throws IOException {
        File tmpFile = assertFile(directory, fileName);
     ...
     * @param objects 目标数据
     */
    private void exportExcelData(String sheetName, List<List> objects) throws IOException {
        // 正文样式
     ...
     * 单元格样式列表
     */
    private Map styleMap(Workbook workbook) {
